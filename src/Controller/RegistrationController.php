...
class RegistrationController extends AbstractController
{
    ...
    /**
     * @Route("/updateUser", name="user_update")
     */
    public function updateUser(Request $request, UserPasswordHasherInterface $passwordEncoder,EntityManagerInterface $manager)
    {
        // 1) build the form
        $user = $this->getUser();
